...
const getUserList = async (req:Request,res:Response,next:NextFunction):Promise<any> => {
    try {
        // const users = await user.find();
        // if(users) return res.json(users);

        const response : ResponseWithMessage<IUserData[]> = await getUsersList();
...
const userUpdateGet = (req:Request,res:Response,next:NextFunction) => {
    try {
        res.json(new user({
            userFirstName: "",
            userLastName: "",
...
const updateUserPhotosGet = (req:Request,res:Response,next:NextFunction) => {
    try {
...
const updateUserPhotosPost = async (req:Request,res:Response,next:NextFunction): Promise<any> => {
    try {
        ...
        const userPhotoData = await userPhoto.findOne({ username: req.session.username });
...
const userRoleUpdate = async (req:Request,res:Response,next:NextFunction) => {
    try {
...
const deleteUserGet = async (req:Request,res:Response,next:NextFunction) => {
    try {
        res.json({username:""});
    } catch (error) {
        console.log(error);
...
//user-theme
const changeUserThemeDataGet = (req:Request,res:Response,next:NextFunction): any => {
    try {
...
const getUserThemeData = async (req:Request,res:Response,next:NextFunction) : Promise<any> => {
    try {

        const response = await getUserThemesData(req.body.username);
...
//theme
const changeUserThemeDataPost = async (req:Request,res:Response,next:NextFunction):Promise<any> => {
    try {
        const response : ResponseWithMessage<IUserThemesData> = await changeUserThemesData(req.body.username);
...
//     }
// }
const changeUserNicknameDataPost = async (req: Request, res:Response, next:NextFunction): Promise<any> => {
    try {
        const response : ResponseWithMessage<boolean> = await changeUserNicknameDataService(req.body.username, req.body.newUserNickname);
...
//firstname
const changeUserFirstNameDataPost = async (req:Request, res:Response, next:NextFunction): Promise<any> => {
    try {
...
//lastname
const changeUserLastNameDataPost = async (req:Request, res:Response, next:NextFunction): Promise<any> => {
    try {
...
//email
const changeUserEmailDataPost = async (req:Request, res:Response, next:NextFunction): Promise<any> => {
    try {
...
//dateOfBirth
const changeUserDateOfBirthDataPost = async (req:Request, res:Response, next:NextFunction): Promise<any> => {
    try {
...
export {
    ...
    deleteUser,
    deleteUserGet,
    changeUserThemeDataPost,
    changeUserThemeDataGet,
    getUserThemeData,
    updateUserPhotosGet,
    updateUserPhotosPost,
    changeUserNicknameDataPost,
    changeUserFirstNameDataPost,
    changeUserLastNameDataPost,
    changeUserEmailDataPost,
    changeUserDateOfBirthDataPost
}